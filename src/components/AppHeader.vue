...
const TRUMP_SOUNDS = [
  ...
  '/media/sounds/trump-you-are-fake-news.mp3',
  '/media/sounds/donald-trump-bing-bong-sound-effect_lTRFmBB.mp3',
  '/media/sounds/trump-on-black-supporter_-_look-at-my-african-american_-1.mp3',
  '/media/sounds/fake-news-great.mp3',
  '/media/sounds/trump-quiet-quiet.mp3',
  '/media/sounds/they-indicted-me_ptD0GKj.mp3',
  '/media/sounds/donald-trump.mp3',
  '/media/sounds/in-springfield-theyre-eating-the-dogs.mp3',
  '/media/sounds/10-feet-taller.mp3',
  '/media/sounds/trump-shut-up-silly-woman.mp3',
  '/media/sounds/donald-trump-im-really-rich-sound-effect.mp3',
  '/media/sounds/we-do-a-little-trolling_80cJgd9.mp3',
  '/media/sounds/do-not-come-im-gonna-come.mp3',
  '/media/sounds/i-am-gunna-come.mp3',
  '/media/sounds/skullsound2.mp3',
  '/media/sounds/my-movie_lu1KTdg.mp3',
  '/media/sounds/el-batido.mp3',
  '/media/sounds/yt1s_qwrCPVf.mp3',
  '/media/sounds/sad-trombone_CTCquhN.mp3',
  '/media/sounds/skull-trumpet-gets-spooked.mp3',
]
  ...
  <div :style="{ background: 'linear-gradient(180deg, #0f172a 0%, #0a0e1a 100%)', borderBottom: '1px solid ' + C.border, padding: '10px 12px 0', position: 'sticky', top: 0, zIndex: 100, maxWidth: '800px', margin: '0 auto' }">
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 10px">
      <div style="display: flex; align-items: center; gap: 8px">
        ...
        <span class="wc-mark">WORLD CUP&nbsp;2026</span>
      </div>
